> **ATUALIZAÇÃO DE ESCOPO:** manter as **66 tasks** rastreáveis (OpenSpec) + evidence index das novas superfícies (MCP/browser/Mem0/Caveman/CI/deploy) por owner (REQ-23).
