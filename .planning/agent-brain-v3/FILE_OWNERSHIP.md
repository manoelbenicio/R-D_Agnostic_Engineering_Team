...
## Wave 3 GSD Rebaseline Ownership (ORQ-59)
| Path | Owner | Scope Note |
|---|---|---|
| `.planning/agent-brain-v3/**` | agy-p0-a7 | Documentation-only GSD rebaseline, state, decisions, risks, traceability, evidence |
| `.deploy-control/p0/evidence/gsd-wave3-rebaseline-reconciliation.md` | agy-p0-a7 | Control evidence artifact for Wave 3 GSD rebaseline |
