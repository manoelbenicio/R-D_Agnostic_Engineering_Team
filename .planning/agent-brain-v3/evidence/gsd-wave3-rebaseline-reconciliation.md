...
This evidence artifact records the complete, full live rebaseline of the `.planning/agent-brain-v3/` GSD package against current production facts, the live 52-card Multica Kanban board, and the canonical OpenSpec lineage reconciled under ORQ-62 (`69880b98e1ae4ed0c550dfbe8fbdeef8817a3a90` on branch `agent/agy-p0-a7/eb2c0b57`).
...
- **Canonical SHA**: Consumed final ORQ-62 canonical SHA `69880b98e1ae4ed0c550dfbe8fbdeef8817a3a90` (branch `agent/agy-p0-a7/eb2c0b57`), which integrated ORQ-61 link repairs and passed strict validation (`openspec validate --all --strict`).
...
| `credential-account-home-restoration` | 3.2, 3.4 | **ORQ-13** (IN_PROGRESS) + **ORQ-14** (BLOCKED) | Canonical usage integration (ORQ-13) + real counters (ORQ-14) |
...
## 5. Kanban Inventory Summary (52 Cards)

- **Total Cards**: 52 (ORQ-01 through ORQ-62)
- **Status Breakdown**:
  - `done`: 23 cards
  - `in_review`: 11 cards
  - `in_progress`: 3 cards (ORQ-13, ORQ-41, ORQ-59)
  - `blocked`: 10 cards (ORQ-14, ORQ-37, ORQ-39, ORQ-40, ORQ-42, ORQ-43, ORQ-44, ORQ-60 [wait, ORQ-60 is in_review])
  - `todo`: 1 card (ORQ-47)
