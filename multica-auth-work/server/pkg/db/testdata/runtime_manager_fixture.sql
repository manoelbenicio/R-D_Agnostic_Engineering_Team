...
INSERT INTO runtime_standard (id, owner_id, name)
VALUES (
    '60000000-0000-4000-8000-000000000005',
    '60000000-0000-4000-8000-000000000001',
    'SPE-6 fixture standard'
);
...
VALUES (
    ...
    repeat('1', 64), '60000000-0000-4000-8000-000000000001', 'fixture'
);
...
VALUES (
    ...
    '60000000-0000-4000-8000-000000000002', 'spe6-fixture-daemon', 1
);
...
INSERT INTO credential_home_catalog_entry (
    ...
    first_seen_at, last_seen_at, last_full_scan_at, health_watermark, ttl,
    retention_deadline
)
VALUES (
    ...
    '60000000-0000-4000-8000-00000000000c', 'codex', true, 'healthy',
    now(), now(), now(), now(), interval '1 hour', now() + interval '30 days'
);
...
VALUES (
    ...
    '60000000-0000-4000-8000-00000000000c', 1,
    '60000000-0000-4000-8000-000000000001'
);
...
VALUES (
    ...
    '60000000-0000-4000-8000-00000000000e',
    '60000000-0000-4000-8000-00000000000c', 1, repeat('5', 64)
);
